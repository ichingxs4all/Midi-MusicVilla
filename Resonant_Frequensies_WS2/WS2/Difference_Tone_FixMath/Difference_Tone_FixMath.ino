...
void updateControl() {
  int light_level = mozziAnalogRead<8>(LDR_PIN); // We request 10 bits, here, however. Value is 0-1023
  int timing = mozziAnalogRead<8>(KNOB_PIN); // value is 0-255
  kChangeNoteDelay.set(timing);
