/*
  Plays a fluctuating ambient wash in response to light and a knob sensors,
  using Mozzi sonification library.

  8 control rate oscillators are used to set the volume of 8 audio oscillators.
  Knob readings from a potentiometer are used to set the notes
...
void updateControl(){
  ...
  // read analog inputs
  int temperature = mozziAnalogRead<10>(POTMETER_PIN); // not calibrated to degrees!
