// Simple example of playing a sequenced or a random  MIDI note on channel 1 in a certain scale/range  and in a tempo based on MIDI clock sync. 
// The level of a potentiometer ( sensor) controls a control change parameter;
...
#define TOUCHPIN 6 //A touch button sensor is connected to pin 6 ( D6 )
...
int range = 12; //The range of notes to choose from by random
