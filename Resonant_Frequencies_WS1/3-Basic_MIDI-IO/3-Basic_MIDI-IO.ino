// Simple example of playing a fixed MIDI note on channel 1 in a tempo based on a fixed value
...
int channel = 1; //The MIDI channel we are going to send messages to. Make this the channel number your synthesizer is set on. Or set the synthesizer to channel 1
