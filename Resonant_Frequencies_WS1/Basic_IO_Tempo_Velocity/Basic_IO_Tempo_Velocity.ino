...
void loop()
{
    ...
    velocity = analogRead(A1)/10 ; // Read analog port A1 and put the value in the parameter velocity. The value will be between 0 and 1023 zo we have to divide it by 10 to be in range
